...
const catalogTemplate = (recipes, goTo, page, pages) => html` <section id="catalog">
...
const recipePreview = (recipe, goTo) => html` <article class="preview" @click=${() => goTo('details', recipe._id)}>
    <div class="title">
        <h2>${recipe.name}</h2>
    </div>
